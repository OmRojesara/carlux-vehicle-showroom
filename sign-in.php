...
if(!isset($_SESSION['login_captcha_question']) || !isset($_SESSION['login_captcha_answer'])) {
    $num1 = rand(10, 99);
    $num2 = rand(1, 20);
    $operations = ['+', '-', '*'];
...
<body>
    <div class="container fade-in">
        <div class="illustration slide-in">
            <div class="illustration-content">
                <h2>Welcome Back</h2>
                <p>Sign in to access your CarLux account and continue your journey</p>
            </div>
        </div>
            ...
            <form method="post" id="signinForm">
                ...
                <div class="captcha-section">
                    ...
                    <div class="captcha-question" id="captchaQuestion">
                        <?php echo $_SESSION['login_captcha_question']; ?>
                    </div>
                    
                    <div class="captcha-controls">
                        <button type="button" class="refresh-btn" onclick="refreshLoginCaptcha()">
                ...
                <div class="submit-section">
                    ...
                    <button type="submit" name="signin" class="submit-btn">
                        Sign In
                    </button>
                </div>
            </form>
    ...
    if(isset($_POST['signin']))
    {
        ...
        else if($captcha != $_SESSION['login_captcha_answer'])
        {
            ?>
            <script>
            const Toast = Swal.mixin({
